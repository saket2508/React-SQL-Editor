...
export default function Table({ data, totalRecords, queryStatus, isModified, restoreTable }: Props) {
    return (
        <div className="col-12 col-sm-10">
            ...
            {isModified && <div className="text-end">
                <button className="mt-1 mb-2 btnCustom restoreBtn" onClick={() => restoreTable()}>
                    <svg
